<template>
  <div class="container" style="margin-left: 400px">
    <div
      ...
      style="padding-left: 0px; margin-top: 10px; margin-left: 110px">
      <h3 style="color: black">{{ userInfo.userName }}님의 회원수정 페이지</h3>
      ...
      <div align="right">
        <button @click="modify" class="btn btn-outline-dark btn-round btn-sm">
          수정
        </button>
      </div>
      <modal
        ...
        <template slot="footer">
          <n-button type="danger" link style="margin-left: 80px" @click="remove"
            >확인</n-button
          >
        </template>
      </modal>
