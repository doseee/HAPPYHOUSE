package com.ssafy.happyhouse.board.aop;
...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.happyhouse.board.model..Board*.*(..))")
	...
	@Around(value = "execution(* com.ssafy.happyhouse.board.model..Board*.*(..))")
	...
	@AfterReturning(value = "execution(* com.ssafy.happyhouse.board.model..Board*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.happyhouse.board.model..Board*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.happyhouse.board.model..Board*.list*(..))")
